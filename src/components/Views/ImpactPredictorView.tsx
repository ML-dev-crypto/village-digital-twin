...
/**
 * ImpactPredictorView - Full view wrapper for the GNN Impact Prediction Panel
 * 
 * This view connects the ImpactPredictionPanel to the village store and provides
 * the complete infrastructure state for GNN analysis including:
 * - Roads
 * - Buildings (residential, commercial, schools, hospitals, markets)
 * - Water infrastructure (tanks, pumps, pipes)
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-white flex items-center gap-2">
              ...
              Village Infrastructure Impact Predictor
            </h1>
      ...
      {showScenarios && (
        <div className="bg-orange-900/20 border border-orange-500/30 rounded-xl p-4">
          ...
          <p className="text-xs text-slate-500 mt-3">
            💡 Select the node above in the predictor panel and choose the failure type to see cascading effects
          </p>
        </div>
      )}
